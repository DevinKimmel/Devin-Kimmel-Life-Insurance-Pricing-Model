...
Limitations:
•	No lapse rates – The model assumes all policies will remain in force until death or expiry. This simplifies the framework at the expense of real-world accuracy
